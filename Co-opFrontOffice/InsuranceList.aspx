...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="PanelList" runat="server" BackColor="#FDC995" style="z-index: 1; left: 50px; top: 113px; position: absolute; height: 395px; width: 674px">
            ...
            <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 281px; top: 347px; position: absolute" Text="Add for purchase" />
            ...
            <asp:Label ID="lblChoose" runat="server" style="z-index: 1; left: 18px; top: 291px; position: absolute" Text="Choose Insurance you would like to purchase!"></asp:Label>
        </asp:Panel>
    </form>
</body>
</html>
